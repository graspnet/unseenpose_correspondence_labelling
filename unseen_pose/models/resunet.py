...
class MinkUNetBase(ResNetBase):
  ...
  def __init__(self, in_channels, out_channels, conv1_kernel_size, bn_momentum, D=3, **kwargs):
    super(MinkUNetBase, self).__init__(in_channels, out_channels, conv1_kernel_size, self.DILATIONS, bn_momentum, D)
  ...
  def network_initialization(self, in_channels, out_channels, conv1_kernel_size, dilations, bn_momentum, D):
    ...
    self.final = conv(512, out_channels, kernel_size=1, stride=1, dilation=1, bias=True, D=D)
